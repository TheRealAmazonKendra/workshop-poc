...
/**
 * An AWS Lambda function which executes src/change-controller/change-controller.
 */
export class ChangeControllerFunction extends lambda.Function {
  constructor(scope: Construct, id: string, props?: ChangeControllerFunctionProps) {
    super(scope, id, {
      description: 'src/change-controller/change-controller.lambda.ts',
      ...props,
      runtime: new lambda.Runtime('nodejs14.x', lambda.RuntimeFamily.NODEJS),
      handler: 'index.handler',
      code: lambda.Code.fromAsset(path.join(__dirname, '../../assets/change-controller/change-controller.lambda')),
    });
